...
echo $display ?> <input class="form-control input-md" name="author" placeholder="Write the name of the author"  type="text">
</div>
<div class="form-group mb30">
...
echo $display ?>
<textarea class="form-control" id="editor1" name="body" placeholder="Write your insight here" rows="4"></textarea>
</div>
