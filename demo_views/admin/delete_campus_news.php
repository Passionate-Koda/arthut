...
$edit_info = getEditInfo($conn,$_GET['id'],'campus_news');
...
deleteCampusNews($conn,$edit_info['image_1'],$_GET['id']);
logs($conn, 'deleted', $edit_info['headline'],'campus_news',$hash_id);
}
...
<h2 class="title-2">Are You Sure You Want to delete "<?php echo $edit_info['headline'] ?>"</h2>
