...
$admin_info = adminInfo($conn,$_GET['id']);


$error= [];

if(array_key_exists('yes', $_POST)){
deleteAdmin($conn,$_GET['id']);
logs($conn, 'deleted', $edit_info['fisrtname'],'admin',$hash_id);
}
...
<h2 class="title-2">Are You Sure You Want to delete user "<?php echo $admin_info['firstname']." ".$admin_info['lastname'] ?>"</h2>
