...
$edit_info = getEditInfo($conn,$_GET['id'],'blog');
$error= [];
if(array_key_exists('submit', $_POST)){
  ...
  if(empty($error)){
    ...
    editArticle($conn, $clean,$_GET['id']);
  }
}
?>
<section id="content">
          ...
          <form class="form-ad" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mb30">
              ...
              <div class="form-group mb30">
                ...
                echo $display ?>
                <textarea class="form-control" id="editor1" name="body" placeholder="Write your article here" rows="4"><?php echo $edit_info['body'] ?></textarea>
              </div>
              <br/>
