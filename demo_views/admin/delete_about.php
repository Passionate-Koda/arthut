...
$edit_info = getEditInfo1($conn,$_GET['id'],'about');
$error= [];

if(array_key_exists('yes', $_POST)){
deleteAbout($conn,$_GET['id']);
logs($conn, 'deleted', $edit_info['title'],'article',$sess);
}
...
<h2 class="title-2">Are You Sure You Want to delete "<?php echo $edit_info['name'] ?>"</h2>
